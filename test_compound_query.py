"""
Test the specific compound query that's failing
"""
...
def test_compound_query():
    """Test the specific failing compound query"""
    query = "who is arty arya and at which year pes university electronic city established"
